...
🎯 Tu as gagné un total de ${user.rewards} MBOA !

Voici ton lien de parrainage : ${generateReferralLink(userId)}

📢 Partage-le pour gagner 25 MBOA par filleul validé.
Les récompenses sont créditées chaque samedi dans ton wallet.
Tu recevras une notification chaque fois qu’un filleul termine toutes les étapes.

🏆 Les 10 meilleurs parrains de la semaine gagnent 1000 MBOA chacun !

👑 Offre Ambassadeur MBOACOIN :
- 🎁 10.000 MBOA de bienvenue
- 🤝 Intègre l’équipe officielle du projet
- 📚 Accès à des formations premium
- 🎯 Récompenses exclusives

👇 Clique pour découvrir l’offre exclusive :`, {
